    ...
    <footer className="border-t border-border/50 relative z-10 bg-background">
      ...
      <div className="border-b border-border/30">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="mt-8">
            <a
              href={`https://wa.me/${WHATSAPP}?text=${encodeURIComponent("Olá! Quero saber mais sobre como melhorar a minha posição no Google Maps.")}`}
              target="_blank"
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="font-mono text-[10px] font-bold uppercase tracking-[0.18em] text-muted">Diagnóstico</span>
            </div>
            <p className="text-sm text-muted-dim leading-relaxed">
              Diagnóstico gratuito ao seu perfil no Google Maps — com dados reais
              da concorrência da sua zona e um plano de ação claro.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <a
                href="mailto:geral@pontofinal.site"
                className="flex items-center gap-2.5 text-muted-dim hover:text-foreground transition-colors"
              >
                <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                geral@pontofinal.site
              </a>
            </div>
          </div>
      ...
      <div className="border-t border-border/30">
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-6 text-xs text-muted-dim">
          <span>© {currentYear} PontoFinal. Todos os direitos reservados.</span>
