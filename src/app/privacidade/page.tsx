...
export const metadata: Metadata = {
  title: "VRAXON – Política de Privacidade",
  description: "Como tratamos os seus dados pessoais na VRAXON. Transparência, segurança e conformidade com o GDPR.",
};
    ...
    <div className="min-h-screen bg-background pt-24 pb-16 px-6">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="rounded-2xl border border-border bg-card p-8 shadow-card">
          <p className={pClass}>
            A VRAXON valoriza a sua privacidade. Temos o compromisso de proteger os seus dados e usar
            tecnologia de ponta para lhe dar uma análise poderosa do seu perfil no Google Maps.
          </p>
          ...
          <p className={pClass}>Para exercer os seus direitos, envie um e-mail para <strong className="text-primary">ruben_frazao98@outlook.pt</strong> com assunto "RGPD".</p>

          <h2 className={h2Class}>5. Segurança</h2>
          <p className={pClass}>Usamos encriptação TLS/SSL para todas as comunicações. Os dados são processados por infraestrutura da Vercel (EUA), em conformidade com o Privacy Shield e as cláusulas contratuais padrão da Comissão Europeia.</p>
          ...
          <p className="text-sm text-muted">VRAXON – Ruben Frazão<br/>Email: <strong className="text-primary">ruben_frazao98@outlook.pt</strong><br/>WhatsApp: +351 913 752 933<br/></p>
        </div>
      </div>
    </div>
  );
